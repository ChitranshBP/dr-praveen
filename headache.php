    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="max-w-3xl text-left animate-fade-in-up">
            ...
            <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-3">
                Expert <span class="text-white">Headache</span> Treatment
            </h1>

            <p class="text-sm md:text-base text-white/80 leading-relaxed mb-6 max-w-2xl">
                Comprehensive care for chronic, acute, and complex headache disorders. Dr. Praveen Gupta provides accurate diagnosis and targeted therapies to help you find lasting relief.
            </p>
