...
$pageContent = get_page_content('headache', [
    'hero_badge' => 'Specialized Neurological Care',
    'hero_title' => 'Expert <span class="text-white">Headache</span> Treatment',
    'hero_desc'  => 'Comprehensive care for chronic, acute, and complex headache disorders. Dr. Praveen Gupta provides accurate diagnosis and targeted therapies to help you find lasting relief.',
    'hero_bg'    => 'assets/breadcrumbs/dr-parveen-headache.png',
]);
?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="max-w-3xl text-left animate-fade-in-up">
            ...
            <div class="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm text-white text-xs font-semibold px-3 py-1.5 rounded-full mb-4">
                <i class="fas fa-head-side-virus text-[10px]"></i>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div class="animate-slide-in-left">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-dark-grey mt-3 mb-6">What is a Headache Disorder?</h2>
                <p class="text-dark-grey/70 leading-relaxed mb-6">
                    A headache is pain or discomfort in the head or face area. While almost everyone experiences headaches occasionally, recurrent or persistent headaches can indicate an underlying disorder that requires expert medical evaluation and management.
                </p>
                <p class="text-dark-grey/70 leading-relaxed mb-8">
                    Living with frequent headaches can significantly impact your work, relationships, and emotional well-being. Our clinic focuses on identifying your specific headache type and triggers, creating a customized plan combining preventive strategies and advanced treatments.
                </p>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            <div class="font-semibold text-dark-grey text-sm">Highly Common</div>
                            <div class="text-xs text-dark-grey/60">Affects millions daily</div>
                        </div>
                    </div>
                    <div class="flex items-start space-x-3">
                        <div class="w-8 h-8 bg-electric-blue/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <div>
                            <div class="font-semibold text-dark-grey text-sm">Various Types</div>
                            <div class="text-xs text-dark-grey/60">Over 150 diagnostic categories</div>
                        </div>
                    </div>
                    <div class="flex items-start space-x-3">
                        <div class="w-8 h-8 bg-electric-blue/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <div>
                            <div class="font-semibold text-dark-grey text-sm">Manageable Triggers</div>
                            <div class="text-xs text-dark-grey/60">Lifestyle factors play a role</div>
                        </div>
                    </div>
                    <div class="flex items-start space-x-3">
                        <div class="w-8 h-8 bg-electric-blue/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <div>
                            <div class="font-semibold text-dark-grey text-sm">Effective Treatment</div>
                            <div class="text-xs text-dark-grey/60">Targeted therapies prevent attacks</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="relative flex justify-center lg:justify-end animate-slide-in-right">
                <div class="relative w-full max-w-md lg:max-w-none aspect-[4/3] rounded-[32px] overflow-hidden shadow-2xl bg-gradient-to-br from-soft-cyan to-silver-grey border border-silver-grey/20">
                    <img src="assets/services/headache.png" alt="Understanding Headache" class="w-full h-full object-cover">
                </div>
            </div>
        </div>
    </div>
...
<section class="py-12 bg-[#edf5f9]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-dark-grey mt-3 mb-6">Common Headache Types</h2>
            <p class="text-dark-grey/70 leading-relaxed">
                Headaches are classified as primary (not caused by another condition) or secondary (caused by an underlying health problem).
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 hover:shadow-lg hover:border-electric-blue/20 transition-all duration-300 group">
                <div class="w-14 h-14 bg-electric-blue/10 rounded-xl flex items-center justify-center mb-5 group-hover:bg-electric-blue group-hover:text-white transition-all duration-300">
                    <i class="fas fa-head-side-virus text-electric-blue text-xl group-hover:text-white transition-colors"></i>
                </div>
                <h3 class="text-lg font-bold text-dark-grey mb-3">Tension Headache</h3>
                <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                    The most common type, causing a constant dull ache or feeling of tight band pressure around the forehead, back of the head, and neck. Usually related to stress or muscle tension.
                </p>
                <div class="flex flex-wrap gap-2">
                    <span class="text-xs bg-electric-blue/10 text-electric-blue px-3 py-1 rounded-full font-medium">Stress-Related</span>
                    <span class="text-xs bg-electric-blue/10 text-electric-blue px-3 py-1 rounded-full font-medium">Muscle Tension</span>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 hover:shadow-lg hover:border-electric-blue/20 transition-all duration-300 group">
                ...
                <h3 class="text-lg font-bold text-dark-grey mb-3">Cluster Headache</h3>
                <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                    Severe, piercing pain that occurs in cycles or clusters, usually concentrated around one eye. Often accompanied by watering of the eye, nasal congestion, and restlessness.
                </p>
                <div class="flex flex-wrap gap-2">
                    <span class="text-xs bg-cyan-accent/10 text-cyan-accent px-3 py-1 rounded-full font-medium">Cyclic Pain</span>
                    <span class="text-xs bg-cyan-accent/10 text-cyan-accent px-3 py-1 rounded-full font-medium">One-Sided</span>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 hover:shadow-lg hover:border-electric-blue/20 transition-all duration-300 group">
                <div class="w-14 h-14 bg-deep-indigo/10 rounded-xl flex items-center justify-center mb-5 group-hover:bg-deep-indigo transition-all duration-300">
                    <i class="fas fa-circle-info text-deep-indigo text-xl group-hover:text-white transition-colors"></i>
                </div>
                <h3 class="text-lg font-bold text-dark-grey mb-3">Secondary Headache</h3>
                <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                    Headaches resulting from other medical conditions, such as sinus infections, dental problems, high blood pressure, head injuries, or blood vessel issues in the brain.
                </p>
                <div class="flex flex-wrap gap-2">
                    <span class="text-xs bg-deep-indigo/10 text-deep-indigo px-3 py-1 rounded-full font-medium">Symptomatic</span>
                    <span class="text-xs bg-deep-indigo/10 text-deep-indigo px-3 py-1 rounded-full font-medium">Diagnostic Needs</span>
                </div>
            </div>
        </div>
        ...
        <div class="mt-12 bg-white rounded-2xl p-8 border border-silver-grey/20">
            <div class="flex items-start space-x-4 mb-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-dark-grey/60 mt-1">Call emergency services immediately if a headache is:</p>
                </div>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div class="flex items-center space-x-3 text-sm">
                    <i class="fas fa-circle text-red-400 text-[6px]"></i>
                    <span class="text-dark-grey/80">Sudden, explosive, and extremely severe</span>
                </div>
                <div class="flex items-center space-x-3 text-sm">
                    <i class="fas fa-circle text-red-400 text-[6px]"></i>
                    <span class="text-dark-grey/80">Accompanied by fever, stiff neck, or confusion</span>
                </div>
                <div class="flex items-center space-x-3 text-sm">
                    <i class="fas fa-circle text-red-400 text-[6px]"></i>
                    <span class="text-dark-grey/80">Linked to weakness, numbness, or speech difficulty</span>
                </div>
                <div class="flex items-center space-x-3 text-sm">
                    <i class="fas fa-circle text-red-400 text-[6px]"></i>
                    <span class="text-dark-grey/80">Occurs after a head injury or trauma</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative order-2 lg:order-1">
                <div class="rounded-[32px] overflow-hidden shadow-xl">
                    <img src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&w=800&h=600&q=80" alt="Headache Symptoms Recognition and Diagnosis" class="w-full h-auto">
                </div>
            ...
            <div class="order-1 lg:order-2">
                ...
                <p class="text-dark-grey/70 leading-relaxed mb-8">
                    Correctly identifying headache symptoms helps differentiate between primary tension headaches, cluster headaches, and secondary headache issues.
                </p>
                ...
                <div class="grid grid-cols-2 gap-4 mb-8">
                    ...
                    <div class="bg-[#edf5f9] rounded-xl p-4">
                        <div class="flex items-center space-x-3 mb-3">
                            <i class="fas fa-user-injured text-electric-blue"></i>
                            <span class="font-semibold text-dark-grey text-sm">Physical Signs</span>
                        </div>
                        <ul class="space-y-2 text-sm text-dark-grey/70">
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-electric-blue/60 text-[10px]"></i>
                                <span>Constant dull ache</span>
                            </li>
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-electric-blue/60 text-[10px]"></i>
                                <span>Eye watering or redness</span>
                            </li>
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-electric-blue/60 text-[10px]"></i>
                            ...
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-electric-blue/60 text-[10px]"></i>
                                <span>Neck muscle stiffness</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-[#edf5f9] rounded-xl p-4">
                        <div class="flex items-center space-x-3 mb-3">
                            ...
                            <span class="font-semibold text-dark-grey text-sm">Sensory & Mental</span>
                        </div>
                        <ul class="space-y-2 text-sm text-dark-grey/70">
                            <li class="flex items-center space-x-2">
                            ...
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-cyan-accent/60 text-[10px]"></i>
                                <span>Light/sound sensitivity</span>
                            </li>
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-cyan-accent/60 text-[10px]"></i>
                                <span>Concentration issues</span>
                            </li>
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-cyan-accent/60 text-[10px]"></i>
                                <span>Irritability or fatigue</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="bg-electric-blue/5 border border-electric-blue/20 rounded-xl p-4">
                    <div class="flex items-start space-x-3 mb-3">
                        <i class="fas fa-info-circle text-electric-blue mt-0.5"></i>
                        <span class="font-semibold text-dark-grey text-sm">Headache Trigger Diary</span>
                    </div>
                    <p class="text-xs text-dark-grey/60 leading-relaxed">
                        Keeping track of sleep patterns, stress levels, dietary habits, and atmospheric changes can provide invaluable information to help optimize your treatment plan.
                    </p>
                </div>
            </div>
        </div>
...
<section class="py-12 bg-[#edf5f9]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-dark-grey mt-3 mb-6">Diagnosing Headache Disorders</h2>
            <p class="text-dark-grey/70 leading-relaxed">
                Accurate classification is key. We run dedicated neurological evaluations to differentiate harmless primary headaches from complex secondary conditions.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            ...
            <div class="relative">
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 h-full">
                    ...
                    <h3 class="text-lg font-bold text-dark-grey mb-3">Medical History</h3>
                    <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                        In-depth evaluation of your headache patterns, severity, location, duration, family history, and possible lifestyle triggers.
                    </p>
                </div>
            ...
            <div class="relative">
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 h-full">
                    ...
                    <h3 class="text-lg font-bold text-dark-grey mb-3">Neurological Exam</h3>
                    <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                        Testing motor skills, cranial nerve function, sensory responses, balance, and reflexes to verify neurological integrity.
                    </p>
                </div>
                <div class="hidden lg:block absolute top-1/2 -right-3 transform -translate-y-1/2 text-electric-blue/30">
                    <i class="fas fa-chevron-right text-xl"></i>
            ...
            <div class="relative">
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 h-full">
                    ...
                    <h3 class="text-lg font-bold text-dark-grey mb-3">Brain MRI / CT</h3>
                    <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                        High-resolution imaging to rule out brain abnormalities, aneurysms, tumors, or internal structural issues.
                    </p>
                </div>
                <div class="hidden lg:block absolute top-1/2 -right-3 transform -translate-y-1/2 text-electric-blue/30">
                    <i class="fas fa-chevron-right text-xl"></i>
            ...
            <div class="relative">
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 h-full">
                    ...
                    <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                        Blood investigations to rule out toxic, endocrine, infectious, or systemic causes behind secondary headache symptoms.
                    </p>
                </div>
            </div>
        </div>
...
<section class="py-12 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-dark-grey mt-3 mb-6">Comprehensive Headache Treatments</h2>
            <p class="text-dark-grey/70 leading-relaxed">
                We believe in personalized, multi-layered treatment plans that address immediate headache pain while preventing future occurrences.
            </p>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-8 mb-16">
            ...
            <div class="bg-gradient-to-br from-electric-blue/5 to-cyan-accent/5 rounded-[24px] p-8 border border-electric-blue/10">
                <div class="flex items-start space-x-5 mb-6">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-dark-grey mb-2">Acute & Pain-Relief Therapies</h3>
                        <p class="text-sm text-dark-grey/60">Immediate management of attacks</p>
                    </div>
                </div>
                <p class="text-dark-grey/70 leading-relaxed mb-6">
                    Taken at the very first sign of a headache, acute therapies block nerve signals and relieve pain, nausea, and sensory sensitivities.
                </p>
                <ul class="space-y-3">
                    <li class="flex items-start space-x-3">
                        ...
                        <span class="text-sm text-dark-grey/80">Targeted pain-relief medications</span>
                    </li>
                    <li class="flex items-start space-x-3">
                        <div class="w-6 h-6 bg-electric-blue/10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <i class="fas fa-check text-electric-blue text-[10px]"></i>
                        </div>
                        <span class="text-sm text-dark-grey/80">Anti-nausea treatments</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-gradient-to-br from-cyan-accent/5 to-electric-blue/5 rounded-[24px] p-8 border border-cyan-accent/10">
                <div class="flex items-start space-x-5 mb-6">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-dark-grey mb-2">Preventive Therapies</h3>
                        <p class="text-sm text-dark-grey/60">Reduce attack frequency and severity</p>
                    </div>
                </div>
                <p class="text-dark-grey/70 leading-relaxed mb-6">
                    For chronic headaches, daily medications or injections help desensitize nerve pathways, reducing the frequency, duration, and severity of attacks.
                </p>
                <ul class="space-y-3">
                    <li class="flex items-start space-x-3">
                        ...
                        <span class="text-sm text-dark-grey/80">Daily preventive medications</span>
                    </li>
                    <li class="flex items-start space-x-3">
                        <div class="w-6 h-6 bg-cyan-accent/10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <i class="fas fa-check text-cyan-accent text-[10px]"></i>
                        </div>
                        <span class="text-sm text-dark-grey/80">Advanced neuromodulation options</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-gradient-to-br from-deep-indigo/5 to-electric-blue/5 rounded-[24px] p-8 border border-deep-indigo/10">
                <div class="flex items-start space-x-5 mb-6">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-dark-grey mb-2">Interventional Procedures</h3>
                        <p class="text-sm text-dark-grey/60">Nerve blocks and localized therapies</p>
                    </div>
                </div>
                <p class="text-dark-grey/70 leading-relaxed mb-6">
                    Occipital nerve blocks and trigger point injections can rapidly desensitize inflamed nerves, providing relief from severe headache cycles.
                </p>
                <ul class="space-y-3">
                    <li class="flex items-start space-x-3">
                        ...
                        <span class="text-sm text-dark-grey/80">Occipital nerve blocks</span>
                    </li>
                    <li class="flex items-start space-x-3">
                        <div class="w-6 h-6 bg-deep-indigo/10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <i class="fas fa-check text-deep-indigo text-[10px]"></i>
                        </div>
                        <span class="text-sm text-dark-grey/80">Trigger point muscle injections</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-gradient-to-br from-silver-grey/30 to-white rounded-[24px] p-8 border border-silver-grey/40">
                <div class="flex items-start space-x-5 mb-6">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-dark-grey mb-2">Lifestyle & Wellness Plan</h3>
                        <p class="text-sm text-dark-grey/60">Holistic support & trigger mapping</p>
                    </div>
                </div>
                <p class="text-dark-grey/70 leading-relaxed mb-6">
                    Optimizing sleep, managing stress, eliminating dietary triggers, and staying hydrated form the foundation of long-term headache freedom.
                </p>
                <ul class="space-y-3">
                    <li class="flex items-start space-x-3">
                        ...
                        <span class="text-sm text-dark-grey/80">Sleep and stress hygiene guidance</span>
                    </li>
                    <li class="flex items-start space-x-3">
                        <div class="w-6 h-6 bg-dark-grey/10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <i class="fas fa-check text-dark-grey text-[10px]"></i>
                        </div>
                        <span class="text-sm text-dark-grey/80">Dietary trigger identification</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div class="lg:col-span-5 lg:sticky lg:top-24 self-start">
                ...
                <p class="text-dark-grey/70 leading-relaxed max-w-md">
                    Answers to common questions regarding headache types, triggers, and relief treatments.
                </p>
            </div>
                ...
                <div class="space-y-4" id="faq-container">
                    ...
                    <div class="faq-item bg-white rounded-2xl overflow-hidden border border-slate-200/80 transition-all duration-300">
                        <button class="faq-toggle w-full flex justify-between items-center p-6 text-left focus:outline-none" onclick="toggleFaq(this)">
                            <span class="font-semibold text-dark-grey pr-4 transition-colors duration-300">When should I consult a neurologist for a headache?</span>
                        ...
                        <div class="faq-content hidden px-6 pb-6">
                            <p class="text-dark-grey/70 leading-relaxed">
                                You should consult a neurologist if your headaches are chronic (occurring 15 or more days a month), sudden and exceptionally severe, accompanied by neurological symptoms (like weakness, numbness, speech difficulties), or if they are unresponsive to over-the-counter pain medications.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item bg-white rounded-2xl overflow-hidden border border-slate-200/80 transition-all duration-300">
                        <button class="faq-toggle w-full flex justify-between items-center p-6 text-left focus:outline-none" onclick="toggleFaq(this)">
                            <span class="font-semibold text-dark-grey pr-4 transition-colors duration-300">Can stress cause tension-type headaches?</span>
                            <span class="faq-icon-wrapper w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center flex-shrink-0 transition-all duration-300">
                                <i class="fas fa-plus text-dark-grey/50 text-xs transition-transform duration-300"></i>
                            </span>
                        </button>
                        <div class="faq-content hidden px-6 pb-6">
                            <p class="text-dark-grey/70 leading-relaxed">
                                Yes, stress is the most frequently reported trigger for tension headaches. Stress leads to muscle contraction in the shoulders, neck, and scalp, resulting in tension pain. Managing stress through therapy, exercise, and meditation is a key part of treatment.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item bg-white rounded-2xl overflow-hidden border border-slate-200/80 transition-all duration-300">
                        <button class="faq-toggle w-full flex justify-between items-center p-6 text-left focus:outline-none" onclick="toggleFaq(this)">
                            <span class="font-semibold text-dark-grey pr-4 transition-colors duration-300">What are medication overuse (rebound) headaches?</span>
                            <span class="faq-icon-wrapper w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center flex-shrink-0 transition-all duration-300">
                                <i class="fas fa-plus text-dark-grey/50 text-xs transition-transform duration-300"></i>
                            </span>
                        </button>
                        <div class="faq-content hidden px-6 pb-6">
                            <p class="text-dark-grey/70 leading-relaxed">
                                Rebound headaches are caused by frequent, repetitive use of headache relief medications (like triptans, NSAIDs, or combination pain relievers). When the medication wears off, a withdrawal headache occurs, prompting the patient to take more medication, creating a vicious cycle. We help patients safely taper off these medications to break the cycle.
                            </p>
                        </div>
                    </div>
                </div>
