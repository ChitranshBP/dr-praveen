...
<section class="relative overflow-hidden bg-gradient-to-br from-deep-indigo via-electric-blue to-cyan-accent text-white pt-28 md:pt-32 pb-8 md:pb-10 -mt-20">
    ...
    <img src="assets/breadcrumbs/dr-parveen-migraine.png" alt=""
         fetchpriority="high"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="max-w-3xl text-left animate-fade-in-up">
            ...
            <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-3">
                Expert <span class="text-white">Migraine</span> Treatment
            </h1>

            <p class="text-sm md:text-base text-white/80 leading-relaxed mb-6 max-w-2xl">
                Advanced relief plans and prevention programs for acute and chronic migraine. Dr. Praveen Gupta provides customized care to help you regain control of your life.
            </p>
