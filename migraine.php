<?php
/**
 * Migraine Service Page - Dr. Praveen Gupta
 */
$isDarkHero = true;
require_once __DIR__ . '/includes/header.php';

$pageContent = get_page_content('migraine', [
    'hero_badge' => 'Specialized Neurological Care',
    'hero_title' => 'Expert <span class="text-white">Migraine</span> Treatment',
    'hero_desc'  => 'Advanced relief plans and prevention programs for acute and chronic migraine. Dr. Praveen Gupta provides customized care to help you regain control of your life.',
    'hero_bg'    => 'assets/breadcrumbs/dr-parveen-migraine.png',
]);
?>
...
<section class="relative overflow-hidden bg-gradient-to-br from-deep-indigo via-electric-blue to-cyan-accent text-white pt-28 md:pt-32 pb-8 md:pb-10 -mt-20">
    ...
    <img src="<?php echo htmlspecialchars($pageContent['hero_bg']); ?>" alt=""
         fetchpriority="high"
         class="absolute inset-0 w-full h-full object-cover object-[68%_center] md:object-right pointer-events-none select-none">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="max-w-3xl text-left animate-fade-in-up">
            ...
            <nav class="flex items-center space-x-2 text-white/80 text-sm mb-3">
                ...
                <i class="fas fa-chevron-right text-[8px]"></i>
                <span class="text-white font-medium">Migraine</span>
            </nav>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div class="animate-slide-in-left">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-dark-grey mt-3 mb-6">What is a Migraine?</h2>
                <p class="text-dark-grey/70 leading-relaxed mb-6">
                    A migraine is a neurological condition that causes intense, throbbing head pain, usually on one side. Unlike common tension headaches, migraines often present with associated symptoms like severe nausea, vomiting, and extreme sensitivity to light, sound, and smell.
                </p>
                <p class="text-dark-grey/70 leading-relaxed mb-8">
                    An attack can last from several hours to days, making daily activities impossible. Our targeted diagnostic and therapy framework aims to reduce the severity and frequency of your migraine episodes using cutting-edge medical treatments.
                </p>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            <div class="font-semibold text-dark-grey text-sm">Neurological Basis</div>
                            <div class="text-xs text-dark-grey/60">Involves brain chemicals & nerves</div>
                        </div>
                    </div>
                    <div class="flex items-start space-x-3">
                        <div class="w-8 h-8 bg-electric-blue/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <div>
                            <div class="font-semibold text-dark-grey text-sm">Aura Phase</div>
                            <div class="text-xs text-dark-grey/60">Visual cues in 25% of cases</div>
                        </div>
                    </div>
                    <div class="flex items-start space-x-3">
                        <div class="w-8 h-8 bg-electric-blue/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <div>
                            <div class="font-semibold text-dark-grey text-sm">Hereditary Aspect</div>
                            <div class="text-xs text-dark-grey/60">Family history is common</div>
                        </div>
                    </div>
                    <div class="flex items-start space-x-3">
                        <div class="w-8 h-8 bg-electric-blue/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <div>
                            <div class="font-semibold text-dark-grey text-sm">Modern Therapies</div>
                            <div class="text-xs text-dark-grey/60">CGRP inhibitors and Botox work</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="relative flex justify-center lg:justify-end animate-slide-in-right">
                <div class="relative w-full max-w-md lg:max-w-none aspect-[4/3] rounded-[32px] overflow-hidden shadow-2xl bg-gradient-to-br from-soft-cyan to-silver-grey border border-silver-grey/20">
                    <img src="assets/services/migraine.png" alt="Understanding Migraine" class="w-full h-full object-cover">
                </div>
            </div>
        </div>
    </div>
...
<section class="py-12 bg-[#edf5f9]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-dark-grey mt-3 mb-6">Types of Migraines</h2>
            <p class="text-dark-grey/70 leading-relaxed">
                Migraines are classified depending on the presence of sensory warning signs called auras.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 hover:shadow-lg hover:border-electric-blue/20 transition-all duration-300 group">
                <div class="w-14 h-14 bg-electric-blue/10 rounded-xl flex items-center justify-center mb-5 group-hover:bg-electric-blue group-hover:text-white transition-all duration-300">
                    <i class="fas fa-eye text-electric-blue text-xl group-hover:text-white transition-colors"></i>
                </div>
                <h3 class="text-lg font-bold text-dark-grey mb-3">Migraine with Aura</h3>
                <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                    Preceded by visual flashes, blind spots, tingling in hands/face, or temporary speech issues about 10-60 minutes before the headache begins.
                </p>
                <div class="flex flex-wrap gap-2">
                    <span class="text-xs bg-electric-blue/10 text-electric-blue px-3 py-1 rounded-full font-medium">Visual Aura</span>
                    <span class="text-xs bg-electric-blue/10 text-electric-blue px-3 py-1 rounded-full font-medium">Sensory Warning</span>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 hover:shadow-lg hover:border-electric-blue/20 transition-all duration-300 group">
                <div class="w-14 h-14 bg-cyan-accent/10 rounded-xl flex items-center justify-center mb-5 group-hover:bg-cyan-accent transition-all duration-300">
                    <i class="fas fa-head-side-slash text-cyan-accent text-xl group-hover:text-white transition-colors"></i>
                </div>
                <h3 class="text-lg font-bold text-dark-grey mb-3">Migraine without Aura</h3>
                <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                    The most common type. Severe, throbbing, one-sided pain occurs without prior warning signs, lasting 4-72 hours if left untreated.
                </p>
                <div class="flex flex-wrap gap-2">
                    <span class="text-xs bg-cyan-accent/10 text-cyan-accent px-3 py-1 rounded-full font-medium">Common Type</span>
                    <span class="text-xs bg-cyan-accent/10 text-cyan-accent px-3 py-1 rounded-full font-medium">Pulsating Pain</span>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 hover:shadow-lg hover:border-electric-blue/20 transition-all duration-300 group">
                <div class="w-14 h-14 bg-deep-indigo/10 rounded-xl flex items-center justify-center mb-5 group-hover:bg-deep-indigo transition-all duration-300">
                    <i class="fas fa-calendar-days text-deep-indigo text-xl group-hover:text-white transition-colors"></i>
                </div>
                <h3 class="text-lg font-bold text-dark-grey mb-3">Chronic Migraine</h3>
                <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                    Diagnosed when headaches occur on 15 or more days a month for at least 3 months, with at least 8 of those days presenting as typical migraines.
                </p>
                <div class="flex flex-wrap gap-2">
                    <span class="text-xs bg-deep-indigo/10 text-deep-indigo px-3 py-1 rounded-full font-medium">Severe Pattern</span>
                    <span class="text-xs bg-deep-indigo/10 text-deep-indigo px-3 py-1 rounded-full font-medium">Daily Impact</span>
                </div>
            </div>
        </div>
        ...
        <div class="mt-12 bg-white rounded-2xl p-8 border border-silver-grey/20">
            <div class="flex items-start space-x-4 mb-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-dark-grey/60 mt-1">Seek immediate medical attention if your symptoms include:</p>
                </div>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div class="flex items-center space-x-3 text-sm">
                    <i class="fas fa-circle text-red-400 text-[6px]"></i>
                    <span class="text-dark-grey/80">Sudden, explosive "thunderclap" headache</span>
                </div>
                <div class="flex items-center space-x-3 text-sm">
                    <i class="fas fa-circle text-red-400 text-[6px]"></i>
                    <span class="text-dark-grey/80">Headache with high fever and stiff neck</span>
                </div>
                <div class="flex items-center space-x-3 text-sm">
                    <i class="fas fa-circle text-red-400 text-[6px]"></i>
                    <span class="text-dark-grey/80">Numbness, paralysis, or weakness on one side</span>
                </div>
                <div class="flex items-center space-x-3 text-sm">
                    <i class="fas fa-circle text-red-400 text-[6px]"></i>
                    <span class="text-dark-grey/80">Double vision or difficulty speaking</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative order-2 lg:order-1">
                <div class="rounded-[32px] overflow-hidden shadow-xl">
                    <img src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&w=800&h=600&q=80" alt="Migraine Symptoms Recognition and Diagnosis" class="w-full h-auto">
                </div>
            ...
            <div class="order-1 lg:order-2">
                ...
                <p class="text-dark-grey/70 leading-relaxed mb-8">
                    Migraine symptoms occur in stages, ranging from early fatigue (prodrome) to sensory aura, the painful attack, and post-attack exhaustion (postdrome).
                </p>
                ...
                <div class="grid grid-cols-2 gap-4 mb-8">
                    ...
                    <div class="bg-[#edf5f9] rounded-xl p-4">
                        <div class="flex items-center space-x-3 mb-3">
                            <i class="fas fa-heart-broken text-electric-blue"></i>
                            <span class="font-semibold text-dark-grey text-sm">Key Symptoms</span>
                        </div>
                        <ul class="space-y-2 text-sm text-dark-grey/70">
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-electric-blue/60 text-[10px]"></i>
                                <span>Throbbing, pulsing pain</span>
                            </li>
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-electric-blue/60 text-[10px]"></i>
                            ...
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-electric-blue/60 text-[10px]"></i>
                                <span>Sensitivity to light & sound</span>
                            </li>
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-electric-blue/60 text-[10px]"></i>
                                <span>Worse with movement</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-[#edf5f9] rounded-xl p-4">
                        <div class="flex items-center space-x-3 mb-3">
                            ...
                            <span class="font-semibold text-dark-grey text-sm">Sensory Disturbances</span>
                        </div>
                        <ul class="space-y-2 text-sm text-dark-grey/70">
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-cyan-accent/60 text-[10px]"></i>
                                <span>Flashing lines in vision</span>
                            </li>
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-cyan-accent/60 text-[10px]"></i>
                                <span>Blind spots/scotomas</span>
                            </li>
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-cyan-accent/60 text-[10px]"></i>
                            ...
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-cyan-accent/60 text-[10px]"></i>
                                <span>Temporary slurred speech</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="bg-electric-blue/5 border border-electric-blue/20 rounded-xl p-4">
                    <div class="flex items-center space-x-3 mb-3">
                        <i class="fas fa-face-smile text-electric-blue"></i>
                        <span class="font-semibold text-dark-grey text-sm">Postdrome "Migraine Hangover"</span>
                    </div>
                    <p class="text-xs text-dark-grey/65 leading-relaxed">
                        After the severe pain subsides, patients often experience extreme fatigue, brain fog, and muscle aches lasting up to 24 hours.
                    </p>
                </div>
            </div>
        </div>
...
<section class="py-12 bg-[#edf5f9]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-dark-grey mt-3 mb-6">Diagnosing Migraines</h2>
            <p class="text-dark-grey/70 leading-relaxed">
                We combine historical symptom tracking with diagnostic imaging to identify the specific migraine type and formulate a tailored care plan.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            ...
            <div class="relative">
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 h-full">
                    ...
                    <h3 class="text-lg font-bold text-dark-grey mb-3">Detailed History</h3>
                    <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                        Mapping pain frequency, location, duration, family history, and associated triggers like stress or diet.
                    </p>
                </div>
            ...
            <div class="relative">
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 h-full">
                    ...
                    <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                        Checking reflexes, eye movements, sensation, cranial nerve responses, and coordination.
                    </p>
                </div>
                <div class="hidden lg:block absolute top-1/2 -right-3 transform -translate-y-1/2 text-electric-blue/30">
                    <i class="fas fa-chevron-right text-xl"></i>
            ...
            <div class="relative">
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 h-full">
                    ...
                    <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                        Advanced imaging scans to rule out secondary headache causes, structural issues, or vascular abnormalities.
                    </p>
                </div>
                <div class="hidden lg:block absolute top-1/2 -right-3 transform -translate-y-1/2 text-electric-blue/30">
                    <i class="fas fa-chevron-right text-xl"></i>
            ...
            <div class="relative">
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 h-full">
                    ...
                    <h3 class="text-lg font-bold text-dark-grey mb-3">Trigger Mapping</h3>
                    <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                        Creating a digital diary tracking lifestyle patterns, hormonal cycles, sleep quality, and diet to narrow triggers.
                    </p>
                </div>
            </div>
        </div>
...
<section class="py-12 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-dark-grey mt-3 mb-6">Comprehensive Migraine Treatments</h2>
            <p class="text-dark-grey/70 leading-relaxed">
                We combine modern rescue therapies with long-term prophylaxis to desensitize nerve pathways and reduce migraine burden.
            </p>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-8 mb-16">
            ...
            <div class="bg-gradient-to-br from-electric-blue/5 to-cyan-accent/5 rounded-[24px] p-8 border border-electric-blue/10">
                <div class="flex items-start space-x-5 mb-6">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-dark-grey mb-2">Acute Rescue Medications</h3>
                        <p class="text-sm text-dark-grey/60">Stop migraine attacks in progress</p>
                    </div>
                </div>
                <p class="text-dark-grey/70 leading-relaxed mb-6">
                    Taken immediately when an attack starts, these medications help stop the throbbing pain, sensory sensitivity, and nausea.
                </p>
                <ul class="space-y-3">
                    <li class="flex items-start space-x-3">
                        ...
                        <span class="text-sm text-dark-grey/80">Triptans and Ditans</span>
                    </li>
                    <li class="flex items-start space-x-3">
                        <div class="w-6 h-6 bg-electric-blue/10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <i class="fas fa-check text-electric-blue text-[10px]"></i>
                        </div>
                        <span class="text-sm text-dark-grey/80">CGRP receptor antagonists (gepants)</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-gradient-to-br from-cyan-accent/5 to-electric-blue/5 rounded-[24px] p-8 border border-cyan-accent/10">
                <div class="flex items-start space-x-5 mb-6">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-dark-grey mb-2">Preventive Treatment</h3>
                        <p class="text-sm text-dark-grey/60">Reduce attack frequency & severity</p>
                    </div>
                </div>
                <p class="text-dark-grey/70 leading-relaxed mb-6">
                    For patients with frequent attacks, daily oral medications or monthly injections help prevent the brain from launching a migraine episode.
                </p>
                <ul class="space-y-3">
                    <li class="flex items-start space-x-3">
                        ...
                        <span class="text-sm text-dark-grey/80">Beta-blockers, anticonvulsants, or antidepressants</span>
                    </li>
                    <li class="flex items-start space-x-3">
                        <div class="w-6 h-6 bg-cyan-accent/10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <i class="fas fa-check text-cyan-accent text-[10px]"></i>
                        </div>
                        <span class="text-sm text-dark-grey/80">Monoclonal antibody CGRP blocker injections</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-gradient-to-br from-deep-indigo/5 to-electric-blue/5 rounded-[24px] p-8 border border-deep-indigo/10">
                <div class="flex items-start space-x-5 mb-6">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-dark-grey mb-2">Botox Injections</h3>
                        <p class="text-sm text-dark-grey/60">FDA-approved chronic migraine relief</p>
                    </div>
                </div>
                <p class="text-dark-grey/70 leading-relaxed mb-6">
                    Botox injections administered every 12 weeks around the head and neck block pain transmitters, providing substantial relief for chronic migraine.
                </p>
                <ul class="space-y-3">
                    <li class="flex items-start space-x-3">
                        ...
                        <span class="text-sm text-dark-grey/80">Targeted muscle injections</span>
                    </li>
                    <li class="flex items-start space-x-3">
                        <div class="w-6 h-6 bg-deep-indigo/10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <i class="fas fa-check text-deep-indigo text-[10px]"></i>
                        </div>
                        <span class="text-sm text-dark-grey/80">Blocks chronic pain pathway receptors</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-gradient-to-br from-silver-grey/30 to-white rounded-[24px] p-8 border border-silver-grey/40">
                <div class="flex items-start space-x-5 mb-6">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-dark-grey mb-2">Lifestyle & Wellness</h3>
                        <p class="text-sm text-dark-grey/60">Holistic support & trigger mapping</p>
                    </div>
                </div>
                <p class="text-dark-grey/70 leading-relaxed mb-6">
                    Proper hydration, consistent sleep schedules, stress reduction, and healthy nutrition are critical to reducing migraine triggers.
                </p>
                <ul class="space-y-3">
                    <li class="flex items-start space-x-3">
                        ...
                        <span class="text-sm text-dark-grey/80">Sleep hygiene & hydration tracking</span>
                    </li>
                    <li class="flex items-start space-x-3">
                        <div class="w-6 h-6 bg-dark-grey/10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <i class="fas fa-check text-dark-grey text-[10px]"></i>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div class="lg:col-span-5 lg:sticky lg:top-24 self-start">
                ...
                <p class="text-dark-grey/70 leading-relaxed max-w-md">
                    Answers to common questions regarding migraine types, triggers, and relief treatments.
                </p>
            </div>
                ...
                <div class="space-y-4" id="faq-container">
                    ...
                    <div class="faq-item bg-white rounded-2xl overflow-hidden border border-slate-200/80 transition-all duration-300">
                        <button class="faq-toggle w-full flex justify-between items-center p-6 text-left focus:outline-none" onclick="toggleFaq(this)">
                            <span class="font-semibold text-dark-grey pr-4 transition-colors duration-300">What is the difference between a headache and a migraine?</span>
                        ...
                        <div class="faq-content hidden px-6 pb-6">
                            <p class="text-dark-grey/70 leading-relaxed">
                                A headache causes general pain in the head or neck area, while a migraine is a complex neurological disorder. Migraines cause throbbing, pulse-like pain (typically on one side), often accompanied by sensory sensitivities (light, sound, smell), severe nausea, or visual auras.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item bg-white rounded-2xl overflow-hidden border border-slate-200/80 transition-all duration-300">
                        <button class="faq-toggle w-full flex justify-between items-center p-6 text-left focus:outline-none" onclick="toggleFaq(this)">
                            <span class="font-semibold text-dark-grey pr-4 transition-colors duration-300">What are common migraine triggers?</span>
                            <span class="faq-icon-wrapper w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center flex-shrink-0 transition-all duration-300">
                                <i class="fas fa-plus text-dark-grey/50 text-xs transition-transform duration-300"></i>
                            </span>
                        </button>
                        <div class="faq-content hidden px-6 pb-6">
                            <p class="text-dark-grey/70 leading-relaxed">
                                Common triggers vary but include hormonal fluctuations, stress, skipped meals, dehydration, lack of sleep, sensory stimuli (bright lights, loud noises), changes in weather, and certain foods or beverages (such as caffeine or aged cheeses).
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item bg-white rounded-2xl overflow-hidden border border-slate-200/80 transition-all duration-300">
                        <button class="faq-toggle w-full flex justify-between items-center p-6 text-left focus:outline-none" onclick="toggleFaq(this)">
                            <span class="font-semibold text-dark-grey pr-4 transition-colors duration-300">Can migraines be cured completely?</span>
                            <span class="faq-icon-wrapper w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center flex-shrink-0 transition-all duration-300">
                                <i class="fas fa-plus text-dark-grey/50 text-xs transition-transform duration-300"></i>
                            </span>
                        </button>
                        <div class="faq-content hidden px-6 pb-6">
                            <p class="text-dark-grey/70 leading-relaxed">
                                While there is currently no cure for migraines, modern therapies (such as Botox, CGRP injections, and oral preventive medications) can dramatically reduce the frequency, duration, and severity of attacks, allowing most sufferers to live completely pain-free lives.
                            </p>
                        </div>
                    </div>
                </div>
