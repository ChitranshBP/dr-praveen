...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-12">
            <span class="text-electric-blue font-bold text-xs uppercase tracking-wider font-sans">Educational Media</span>
            <h2 class="text-3xl font-bold text-deep-indigo font-serif mt-2">Neurological Health Videos</h2>
            <p class="text-sm text-dark-grey/65 mt-3 leading-relaxed">
                Click play to watch medical explainers on vertigo, headaches, dementia, and multiple sclerosis.
            </p>
        </div>
