...
$pageContent = get_page_content('parkinsons', [
    'hero_badge' => 'Specialized Neurological Care',
    'hero_title' => 'Expert <span class="text-white">Parkinson\'s</span> Treatment',
    'hero_desc'  => 'Advanced care plans combining modern pharmacology, motor therapies, and Deep Brain Stimulation (DBS). Dr. Praveen Gupta helps manage symptoms with clinical precision.',
    'hero_bg'    => '',
]);
?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="max-w-3xl text-left animate-fade-in-up">
            ...
            <div class="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm text-white text-xs font-semibold px-3 py-1.5 rounded-full mb-4">
                <i class="fas fa-person-walking-with-cane text-[10px]"></i>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div class="animate-slide-in-left">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-dark-grey mt-3 mb-6">What is Parkinson's Disease?</h2>
                <p class="text-dark-grey/70 leading-relaxed mb-6">
                    Parkinson's disease is a progressive neurodegenerative disorder that mainly affects dopamine-producing neurons in a specific area of the brain called the substantia nigra. Symptoms develop gradually over years, slowly impacting motor control, balance, and coordination.
                </p>
                <p class="text-dark-grey/70 leading-relaxed mb-8">
                    Although Parkinson's cannot be cured completely, modern pharmaceutical management and surgical interventions like Deep Brain Stimulation (DBS) can dramatically reduce symptoms and improve the patient's daily quality of life.
                </p>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            <div class="font-semibold text-dark-grey text-sm">Neurodegenerative</div>
                            <div class="text-xs text-dark-grey/60">Dopamine neuron loss in brain</div>
                        </div>
                    </div>
                    <div class="flex items-start space-x-3">
                        <div class="w-8 h-8 bg-electric-blue/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <div>
                            <div class="font-semibold text-dark-grey text-sm">Gradual Progression</div>
                            <div class="text-xs text-dark-grey/60">Develops slowly over years</div>
                        </div>
                    </div>
                    <div class="flex items-start space-x-3">
                        <div class="w-8 h-8 bg-electric-blue/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <div>
                            <div class="font-semibold text-dark-grey text-sm">DBS Option</div>
                            <div class="text-xs text-dark-grey/60">Neurosurgery blocks motor tremors</div>
                        </div>
                    </div>
                    <div class="flex items-start space-x-3">
                        <div class="w-8 h-8 bg-electric-blue/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <div>
                            ...
                            <div class="text-xs text-dark-grey/60">Helps maintain motor controls</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="relative flex justify-center lg:justify-end animate-slide-in-right">
                <div class="relative w-full max-w-md lg:max-w-none aspect-[4/3] rounded-[32px] overflow-hidden shadow-2xl bg-gradient-to-br from-soft-cyan to-silver-grey border border-silver-grey/20">
                    <img src="assets/services/parkinsons.png" alt="Understanding Parkinson's" class="w-full h-full object-cover">
                </div>
            </div>
        </div>
    </div>
...
<section class="py-12 bg-[#edf5f9]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-dark-grey mt-3 mb-6">Parkinsonian Disorders</h2>
            <p class="text-dark-grey/70 leading-relaxed">
                Symptoms of slowness and tremors can be caused by idiopathic Parkinson's disease or other look-alike syndromes.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 hover:shadow-lg hover:border-electric-blue/20 transition-all duration-300 group">
                ...
                <h3 class="text-lg font-bold text-dark-grey mb-3">Idiopathic Parkinson's</h3>
                <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                    The classic form of the disease. Responsive to levodopa therapy. Primary symptoms include resting tremors, muscle stiffness, and slowness.
                </p>
                <div class="flex flex-wrap gap-2">
                    <span class="text-xs bg-electric-blue/10 text-electric-blue px-3 py-1 rounded-full font-medium">Levodopa Responsive</span>
                    <span class="text-xs bg-electric-blue/10 text-electric-blue px-3 py-1 rounded-full font-medium">Classic Type</span>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 hover:shadow-lg hover:border-electric-blue/20 transition-all duration-300 group">
                <div class="w-14 h-14 bg-cyan-accent/10 rounded-xl flex items-center justify-center mb-5 group-hover:bg-cyan-accent transition-all duration-300">
                    <i class="fas fa-circle-nodes text-cyan-accent text-xl group-hover:text-white transition-colors"></i>
                </div>
                <h3 class="text-lg font-bold text-dark-grey mb-3">Parkinson-Plus</h3>
                <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                    Syndromes like Multiple System Atrophy (MSA) or Progressive Supranuclear Palsy (PSP) that present with tremors but have additional symptoms and progress differently.
                </p>
                <div class="flex flex-wrap gap-2">
                    <span class="text-xs bg-cyan-accent/10 text-cyan-accent px-3 py-1 rounded-full font-medium">Atypical</span>
                    <span class="text-xs bg-cyan-accent/10 text-cyan-accent px-3 py-1 rounded-full font-medium">PSP & MSA</span>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 hover:shadow-lg hover:border-electric-blue/20 transition-all duration-300 group">
                <div class="w-14 h-14 bg-deep-indigo/10 rounded-xl flex items-center justify-center mb-5 group-hover:bg-deep-indigo transition-all duration-300">
                    <i class="fas fa-capsules text-deep-indigo text-xl group-hover:text-white transition-colors"></i>
                </div>
                <h3 class="text-lg font-bold text-dark-grey mb-3">Drug-Induced</h3>
                <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                    Reversible parkinsonism symptoms caused by certain medications (such as antipsychotics) that block dopamine receptors in the brain.
                </p>
                <div class="flex flex-wrap gap-2">
                    <span class="text-xs bg-deep-indigo/10 text-deep-indigo px-3 py-1 rounded-full font-medium">Reversible</span>
                    <span class="text-xs bg-deep-indigo/10 text-deep-indigo px-3 py-1 rounded-full font-medium">Dopamine Block</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative order-2 lg:order-1">
                <div class="rounded-[32px] overflow-hidden shadow-xl">
                    <img src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&w=800&h=600&q=80" alt="Parkinson's Symptoms Recognition and Diagnosis" class="w-full h-auto">
                </div>
            ...
            <div class="order-1 lg:order-2">
                ...
                <p class="text-dark-grey/70 leading-relaxed mb-8">
                    Parkinson's symptoms are divided into motor symptoms (affecting physical movement) and non-motor symptoms (affecting sensory, mood, or sleep functions).
                </p>
                ...
                <div class="grid grid-cols-2 gap-4 mb-8">
                    ...
                    <div class="bg-[#edf5f9] rounded-xl p-4">
                        <div class="flex items-center space-x-3 mb-3">
                            <i class="fas fa-hand text-electric-blue"></i>
                        ...
                        <ul class="space-y-2 text-sm text-dark-grey/70">
                            <li class="flex items-center space-x-2">
                                ...
                                <span>Resting hand tremors</span>
                            </li>
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-electric-blue/60 text-[10px]"></i>
                                <span>Rigidity / muscle stiffness</span>
                            </li>
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-electric-blue/60 text-[10px]"></i>
                            ...
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-electric-blue/60 text-[10px]"></i>
                                <span>Postural instability</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-[#edf5f9] rounded-xl p-4">
                        <div class="flex items-center space-x-3 mb-3">
                            <i class="fas fa-moon text-cyan-accent"></i>
                        ...
                        <ul class="space-y-2 text-sm text-dark-grey/70">
                            <li class="flex items-center space-x-2">
                                ...
                                <span>Loss of smell (anosmia)</span>
                            </li>
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-cyan-accent/60 text-[10px]"></i>
                                <span>REM sleep disturbances</span>
                            </li>
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-cyan-accent/60 text-[10px]"></i>
                                <span>Micrographia (small writing)</span>
                            </li>
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-cyan-accent/60 text-[10px]"></i>
                ...
                <div class="bg-electric-blue/5 border border-electric-blue/20 rounded-xl p-4">
                    <div class="flex items-center space-x-3 mb-3">
                        <i class="fas fa-shield text-electric-blue"></i>
                        <span class="font-semibold text-dark-grey text-sm">Early Diagnosis is Key</span>
                    </div>
                    <p class="text-xs text-dark-grey/65 leading-relaxed">
                        Intervening early with dopamine agonists or levodopa can slow motor decline and preserve independent functioning for years.
                    </p>
                </div>
            </div>
        </div>
...
<section class="py-12 bg-[#edf5f9]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-dark-grey mt-3 mb-6">Diagnosing Parkinson's</h2>
            <p class="text-dark-grey/70 leading-relaxed">
                Diagnosing Parkinson's relies primarily on expert clinical observation of motor patterns, reflexes, and response to specific dopaminergic drugs.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            ...
            <div class="relative">
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 h-full">
                    ...
                    <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                        Expert examination of resting tremors, motor rigidity, postural balance, and gait patterns.
                    </p>
                </div>
            ...
            <div class="relative">
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 h-full">
                    ...
                    <h3 class="text-lg font-bold text-dark-grey mb-3">Drug Challenge</h3>
                    <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                        Assessing physical response to Levodopa medication. A significant improvement in motor speed supports a Parkinson's diagnosis.
                    </p>
                </div>
                <div class="hidden lg:block absolute top-1/2 -right-3 transform -translate-y-1/2 text-electric-blue/30">
                    <i class="fas fa-chevron-right text-xl"></i>
            ...
            <div class="relative">
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 h-full">
                    ...
                    <h3 class="text-lg font-bold text-dark-grey mb-3">DaTscan Imaging</h3>
                    <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                        Dopamine Transporter SPECT scan tracing dopamine pathways in the brain to confirm neurodegenerative drop-offs.
                    </p>
                </div>
                <div class="hidden lg:block absolute top-1/2 -right-3 transform -translate-y-1/2 text-electric-blue/30">
                    <i class="fas fa-chevron-right text-xl"></i>
            ...
            <div class="relative">
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 h-full">
                    ...
                    <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                        High-resolution imaging scans to rule out atypical parkinsonism, strokes, fluid blockages, or brain stem abnormalities.
                    </p>
                </div>
            </div>
        </div>
...
<section class="py-12 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-dark-grey mt-3 mb-6">Comprehensive Parkinson's Treatments</h2>
            <p class="text-dark-grey/70 leading-relaxed">
                We design personalized treatment regimens combining pharmaceutical support, motor training, and advanced neurosurgical referrals.
            </p>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-8 mb-16">
            ...
            <div class="bg-gradient-to-br from-electric-blue/5 to-cyan-accent/5 rounded-[24px] p-8 border border-electric-blue/10">
                <div class="flex items-start space-x-5 mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-dark-grey/60">Replenishing brain dopamine</p>
                    </div>
                </div>
                <p class="text-dark-grey/70 leading-relaxed mb-6">
                    Carbidopa-levodopa (mainstay therapy) converts into dopamine in the brain, restoring signal transmission and motor control.
                </p>
                <ul class="space-y-3">
                    <li class="flex items-start space-x-3">
                        ...
                        <span class="text-sm text-dark-grey/80">Carbidopa-levodopa and dopamine agonists</span>
                    </li>
                    <li class="flex items-start space-x-3">
                        <div class="w-6 h-6 bg-electric-blue/10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <i class="fas fa-check text-electric-blue text-[10px]"></i>
                        </div>
                        <span class="text-sm text-dark-grey/80">MAO-B and COMT enzyme inhibitors</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-gradient-to-br from-cyan-accent/5 to-electric-blue/5 rounded-[24px] p-8 border border-cyan-accent/10">
                <div class="flex items-start space-x-5 mb-6">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-dark-grey mb-2">Deep Brain Stimulation (DBS)</h3>
                        <p class="text-sm text-dark-grey/60">Advanced neurosurgical stimulation</p>
                    </div>
                </div>
                <p class="text-dark-grey/70 leading-relaxed mb-6">
                    Implated electrodes send electrical signals into deep brain structures, significantly reducing rigidity, slow movements, and severe medication-induced tremors.
                </p>
                <ul class="space-y-3">
                    <li class="flex items-start space-x-3">
                        ...
                        <span class="text-sm text-dark-grey/80">Reduces medication fluctuations ("off" times)</span>
                    </li>
                    <li class="flex items-start space-x-3">
                        <div class="w-6 h-6 bg-cyan-accent/10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <i class="fas fa-check text-cyan-accent text-[10px]"></i>
                        </div>
                        <span class="text-sm text-dark-grey/80">FDA-approved surgical option</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-gradient-to-br from-deep-indigo/5 to-electric-blue/5 rounded-[24px] p-8 border border-deep-indigo/10">
                <div class="flex items-start space-x-5 mb-6">
                    <div class="w-16 h-16 bg-deep-indigo rounded-2xl flex items-center justify-center flex-shrink-0">
                        <i class="fas fa-person-running text-white text-2xl"></i>
                    </div>
                    <div>
                        <h3 class="text-xl font-bold text-dark-grey mb-2">Motor & Physical Therapy</h3>
                        <p class="text-sm text-dark-grey/60">Retaining flexibility and balance</p>
                    </div>
                </div>
                <p class="text-dark-grey/70 leading-relaxed mb-6">
                    Structured exercises focus on gait patterns, stretching, fall avoidance, and preserving postural balance.
                </p>
                <ul class="space-y-3">
                    <li class="flex items-start space-x-3">
                        ...
                        <span class="text-sm text-dark-grey/80">LSVT BIG specialized gait training</span>
                    </li>
                    <li class="flex items-start space-x-3">
                        <div class="w-6 h-6 bg-deep-indigo/10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <i class="fas fa-check text-deep-indigo text-[10px]"></i>
                        </div>
                        <span class="text-sm text-dark-grey/80">Balance drills & muscle stretching</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-gradient-to-br from-silver-grey/30 to-white rounded-[24px] p-8 border border-silver-grey/40">
                <div class="flex items-start space-x-5 mb-6">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-dark-grey mb-2">Speech & Daily Task Therapy</h3>
                        <p class="text-sm text-dark-grey/60">Voice retraining & occupational habits</p>
                    </div>
                </div>
                <p class="text-dark-grey/70 leading-relaxed mb-6">
                    LSVT LOUD speech therapies strengthen vocal cords to address quiet speech, while occupational therapy adapts daily routines to preserve independence.
                </p>
                <ul class="space-y-3">
                    <li class="flex items-start space-x-3">
                        ...
                        <span class="text-sm text-dark-grey/80">LSVT LOUD voice coaching</span>
                    </li>
                    <li class="flex items-start space-x-3">
                        <div class="w-6 h-6 bg-dark-grey/10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <i class="fas fa-check text-dark-grey text-[10px]"></i>
                        </div>
                        <span class="text-sm text-dark-grey/80">Occupational therapy modifications</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div class="lg:col-span-5 lg:sticky lg:top-24 self-start">
                ...
                <p class="text-dark-grey/70 leading-relaxed max-w-md">
                    Answers to common questions regarding Parkinson's symptoms, therapies, and surgical options.
                </p>
            </div>
                ...
                <div class="space-y-4" id="faq-container">
                    ...
                    <div class="faq-item bg-white rounded-2xl overflow-hidden border border-slate-200/80 transition-all duration-300">
                        <button class="faq-toggle w-full flex justify-between items-center p-6 text-left focus:outline-none" onclick="toggleFaq(this)">
                            <span class="font-semibold text-dark-grey pr-4 transition-colors duration-300">What are the earliest warning signs of Parkinson's?</span>
                        ...
                        <div class="faq-content hidden px-6 pb-6">
                            <p class="text-dark-grey/70 leading-relaxed">
                                Early signs are often subtle and non-motor. They include loss of smell (anosmia), sleep disturbances, handwriting that becomes smaller (micrographia), a faint resting hand tremor, or a slight stiffness in shoulders and legs that is mistaken for normal aging.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item bg-white rounded-2xl overflow-hidden border border-slate-200/80 transition-all duration-300">
                        <button class="faq-toggle w-full flex justify-between items-center p-6 text-left focus:outline-none" onclick="toggleFaq(this)">
                            <span class="font-semibold text-dark-grey pr-4 transition-colors duration-300">What is Deep Brain Stimulation (DBS) and who is it for?</span>
                            <span class="faq-icon-wrapper w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center flex-shrink-0 transition-all duration-300">
                                <i class="fas fa-plus text-dark-grey/50 text-xs transition-transform duration-300"></i>
                            </span>
                        </button>
                        <div class="faq-content hidden px-6 pb-6">
                            <p class="text-dark-grey/70 leading-relaxed">
                                DBS is a surgical treatment where electrodes are placed in specific brain centers to regulate abnormal electrical activity. It is indicated for patients with idiopathic Parkinson's who experience severe tremors, motor complications, or "off" fluctuations that are no longer managed by Levodopa alone.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item bg-white rounded-2xl overflow-hidden border border-slate-200/80 transition-all duration-300">
                        <button class="faq-toggle w-full flex justify-between items-center p-6 text-left focus:outline-none" onclick="toggleFaq(this)">
                            <span class="font-semibold text-dark-grey pr-4 transition-colors duration-300">Can physical therapy help Parkinson's progress?</span>
                            <span class="faq-icon-wrapper w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center flex-shrink-0 transition-all duration-300">
                                <i class="fas fa-plus text-dark-grey/50 text-xs transition-transform duration-300"></i>
                            </span>
                        </button>
                        <div class="faq-content hidden px-6 pb-6">
                            <p class="text-dark-grey/70 leading-relaxed">
                                Yes. Regular, structured exercise and physical therapies (especially specialized programs like LSVT BIG) help retrain brain pathways, maintain muscle flexibility, improve balance, prevent falls, and significantly delay the onset of severe motor disabilities.
                            </p>
                        </div>
                    </div>
                </div>
