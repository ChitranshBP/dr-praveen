<?php
/**
 * Peripheral Neuropathy Service Page - Dr. Praveen Gupta
 */
$isDarkHero = true;
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="max-w-3xl text-left animate-fade-in-up">
            ...
            <nav class="flex items-center space-x-2 text-white/80 text-sm mb-3">
                ...
                <i class="fas fa-chevron-right text-[8px]"></i>
                <span class="text-white font-medium">Peripheral Neuropathy</span>
            </nav>
...
<!-- What is Peripheral Neuropathy Section -->
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div class="animate-slide-in-left">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-dark-grey mt-3 mb-6">What is Peripheral Neuropathy?</h2>
                <p class="text-dark-grey/70 leading-relaxed mb-6">
                    Peripheral neuropathy refers to damage or dysfunction of the peripheral nerves, which carry information between the brain, spinal cord, and the rest of the body. This condition often results in numbness, tingling, weakness, or sharp, burning pain, commonly starting in the feet and hands (known as a "stocking-glove" pattern).
                </p>
                <p class="text-dark-grey/70 leading-relaxed mb-8">
                    Nerve damage can stem from diabetes, metabolic disorders, vitamin deficiencies, autoimmune diseases, or toxin exposures. Our clinical team focuses on identifying the root cause to halt nerve decline, relieve painful symptoms, and restore normal sensation.
                </p>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            <div class="font-semibold text-dark-grey text-sm">Peripheral Nerves</div>
                            <div class="text-xs text-dark-grey/60">Connects spinal cord to limbs</div>
                        </div>
                    </div>
                    <div class="flex items-start space-x-3">
                        <div class="w-8 h-8 bg-electric-blue/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <div>
                            <div class="font-semibold text-dark-grey text-sm">Diabetic Connection</div>
                            <div class="text-xs text-dark-grey/60">Diabetes is the leading cause</div>
                        </div>
                    </div>
                    <div class="flex items-start space-x-3">
                        <div class="w-8 h-8 bg-electric-blue/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <div>
                            <div class="font-semibold text-dark-grey text-sm">Nerve Regeneration</div>
                            <div class="text-xs text-dark-grey/60">Nerves can heal with care</div>
                        </div>
                    </div>
                    <div class="flex items-start space-x-3">
                        <div class="w-8 h-8 bg-electric-blue/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <div>
                            <div class="font-semibold text-dark-grey text-sm">Targeted Relief</div>
                            <div class="text-xs text-dark-grey/60">Advanced treatments ease pain</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="relative flex justify-center lg:justify-end animate-slide-in-right">
                <div class="relative w-full max-w-md lg:max-w-none aspect-[4/3] rounded-[32px] overflow-hidden shadow-2xl bg-gradient-to-br from-soft-cyan to-silver-grey border border-silver-grey/20">
                    <img src="assets/services/neuropathy.png" alt="Understanding Peripheral Neuropathy" class="w-full h-full object-cover">
                </div>
            </div>
        </div>
    </div>
...
<section class="py-12 bg-[#edf5f9]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-dark-grey mt-3 mb-6">Neuropathy Categories</h2>
            <p class="text-dark-grey/70 leading-relaxed">
                Nerve damage is classified by its underlying trigger, guiding our targeted treatment approach.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 hover:shadow-lg hover:border-electric-blue/20 transition-all duration-300 group">
                <div class="w-14 h-14 bg-electric-blue/10 rounded-xl flex items-center justify-center mb-5 group-hover:bg-electric-blue group-hover:text-white transition-all duration-300">
                    <i class="fas fa-house-medical text-electric-blue text-xl group-hover:text-white transition-colors"></i>
                </div>
                <h3 class="text-lg font-bold text-dark-grey mb-3">Diabetic Neuropathy</h3>
                <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                    The most common form. High blood sugars over time damage small blood vessels that feed peripheral nerves, resulting in chronic numbness or burning in the feet.
                </p>
                <div class="flex flex-wrap gap-2">
                    <span class="text-xs bg-electric-blue/10 text-electric-blue px-3 py-1 rounded-full font-medium">Metabolic Blood Sugar</span>
                    <span class="text-xs bg-electric-blue/10 text-electric-blue px-3 py-1 rounded-full font-medium">Stocking-Glove Pattern</span>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 hover:shadow-lg hover:border-electric-blue/20 transition-all duration-300 group">
                <div class="w-14 h-14 bg-cyan-accent/10 rounded-xl flex items-center justify-center mb-5 group-hover:bg-cyan-accent transition-all duration-300">
                    <i class="fas fa-shield-virus text-cyan-accent text-xl group-hover:text-white transition-colors"></i>
                </div>
                <h3 class="text-lg font-bold text-dark-grey mb-3">Inflammatory Neuropathies</h3>
                <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                    Autoimmune attacks on peripheral myelin. Includes acute Guillain-Barr̩ Syndrome (GBS) and chronic CIDP, presenting with rapidly progressive muscle weakness.
                </p>
                <div class="flex flex-wrap gap-2">
                    <span class="text-xs bg-cyan-accent/10 text-cyan-accent px-3 py-1 rounded-full font-medium">Autoimmune</span>
                    <span class="text-xs bg-cyan-accent/10 text-cyan-accent px-3 py-1 rounded-full font-medium">GBS & CIDP Care</span>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 hover:shadow-lg hover:border-electric-blue/20 transition-all duration-300 group">
                <div class="w-14 h-14 bg-deep-indigo/10 rounded-xl flex items-center justify-center mb-5 group-hover:bg-deep-indigo transition-all duration-300">
                    <i class="fas fa-leaf text-deep-indigo text-xl group-hover:text-white transition-colors"></i>
                </div>
                <h3 class="text-lg font-bold text-dark-grey mb-3">Nutritional & Toxic Neuropathy</h3>
                <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                    Nerve damage due to vitamin deficiencies (such as B12, B1, or B6), chronic alcohol consumption, heavy metals, or chemotherapy drugs.
                </p>
                <div class="flex flex-wrap gap-2">
                    <span class="text-xs bg-deep-indigo/10 text-deep-indigo px-3 py-1 rounded-full font-medium">Vitamin B12 Deficit</span>
                    <span class="text-xs bg-deep-indigo/10 text-deep-indigo px-3 py-1 rounded-full font-medium">Chemotherapy Linked</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative order-2 lg:order-1">
                <div class="rounded-[32px] overflow-hidden shadow-xl">
                    <img src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&w=800&h=600&q=80" alt="Neuropathy Symptoms Recognition and Diagnosis" class="w-full h-auto">
                </div>
            ...
            <div class="order-1 lg:order-2">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-dark-grey mt-3 mb-6">Neuropathy Symptoms</h2>
                <p class="text-dark-grey/70 leading-relaxed mb-8">
                    Neuropathy symptoms vary depending on whether sensory, motor, or autonomic nerves are damaged.
                </p>
                ...
                <div class="grid grid-cols-2 gap-4 mb-8">
                    ...
                    <div class="bg-[#edf5f9] rounded-xl p-4">
                        <div class="flex items-center space-x-3 mb-3">
                            <i class="fas fa-hand-dots text-electric-blue"></i>
                            <span class="font-semibold text-dark-grey text-sm">Sensory Symptoms</span>
                        </div>
                        <ul class="space-y-2 text-sm text-dark-grey/70">
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-electric-blue/60 text-[10px]"></i>
                                <span>Gradual numbness in feet/hands</span>
                            </li>
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-electric-blue/60 text-[10px]"></i>
                                <span>Tingling, buzzing, or pins & needles</span>
                            </li>
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-electric-blue/60 text-[10px]"></i>
                                <span>Burning, sharp, electric pain</span>
                            </li>
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-electric-blue/60 text-[10px]"></i>
                                <span>Extreme touch sensitivity</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-[#edf5f9] rounded-xl p-4">
                        <div class="flex items-center space-x-3 mb-3">
                            <i class="fas fa-user-gear text-cyan-accent"></i>
                            <span class="font-semibold text-dark-grey text-sm">Motor & Autonomic</span>
                        </div>
                        <ul class="space-y-2 text-sm text-dark-grey/70">
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-cyan-accent/60 text-[10px]"></i>
                                <span>Muscle weakness or atrophy</span>
                            </li>
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-cyan-accent/60 text-[10px]"></i>
                                <span>Frequent tripping or foot drop</span>
                            </li>
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-cyan-accent/60 text-[10px]"></i>
                                <span>Balance loss or unsteadiness</span>
                            </li>
                            <li class="flex items-center space-x-2">
                                <i class="fas fa-check text-cyan-accent/60 text-[10px]"></i>
                                <span>Dizziness when standing up</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="bg-electric-blue/5 border border-electric-blue/20 rounded-xl p-4">
                    <div class="flex items-center space-x-3 mb-3">
                        <i class="fas fa-triangle-exclamation text-electric-blue"></i>
                        <span class="font-semibold text-dark-grey text-sm">Autonomic Risks</span>
                    </div>
                    <p class="text-xs text-dark-grey/65 leading-relaxed">
                        Autonomic nerve damage can disrupt internal systems, causing heat intolerance, abnormal sweating, and fluctuations in blood pressure or heart rate.
                    </p>
                </div>
            </div>
        </div>
...
<section class="py-12 bg-[#edf5f9]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-dark-grey mt-3 mb-6">Diagnosing Neuropathy</h2>
            <p class="text-dark-grey/70 leading-relaxed">
                Diagnosing peripheral neuropathy involves checking electrical conduction speed inside nerves, combined with lab screens to pinpoint root causes.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            ...
            <div class="relative">
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 h-full">
                    ...
                    <h3 class="text-lg font-bold text-dark-grey mb-3">EMG & NCV Studies</h3>
                    <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                        Nerve Conduction Velocity (NCV) tests and Electromyography (EMG) measure electrical activity in muscles to locate nerve compression or damage.
                    </p>
                </div>
            ...
            <div class="relative">
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 h-full">
                    ...
                    <h3 class="text-lg font-bold text-dark-grey mb-3">Metabolic Lab Tests</h3>
                    <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                        Comprehensive blood screens checking HbA1c (diabetes), vitamin B12 levels, thyroid markers, renal functions, and autoantibodies.
                    </p>
                </div>
                <div class="hidden lg:block absolute top-1/2 -right-3 transform -translate-y-1/2 text-electric-blue/30">
                    <i class="fas fa-chevron-right text-xl"></i>
            ...
            <div class="relative">
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 h-full">
                    ...
                    <h3 class="text-lg font-bold text-dark-grey mb-3">Quantitative Sensory</h3>
                    <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                        Sensory testing checking temperature shifts, touch thresholds, and vibration limits to identify large vs. small nerve fiber damage.
                    </p>
                </div>
                <div class="hidden lg:block absolute top-1/2 -right-3 transform -translate-y-1/2 text-electric-blue/30">
                    <i class="fas fa-chevron-right text-xl"></i>
            ...
            <div class="relative">
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 h-full">
                    ...
                    <h3 class="text-lg font-bold text-dark-grey mb-3">Skin Biopsy</h3>
                    <p class="text-sm text-dark-grey/60 leading-relaxed mb-4">
                        A minimally invasive, 3mm punch skin biopsy to check intraepidermal nerve fiber density, confirming small fiber neuropathy.
                    </p>
                </div>
            </div>
        </div>
...
<section class="py-12 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-dark-grey mt-3 mb-6">Peripheral Neuropathy Treatments</h2>
            <p class="text-dark-grey/70 leading-relaxed">
                Treating neuropathy involves a dual approach: managing the primary underlying cause to halt damage and using advanced therapies to relieve pain.
            </p>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-8 mb-16">
            ...
            <div class="bg-gradient-to-br from-electric-blue/5 to-cyan-accent/5 rounded-[24px] p-8 border border-electric-blue/10">
                <div class="flex items-start space-x-5 mb-6">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-dark-grey mb-2">Neuropathic Pain Medications</h3>
                        <p class="text-sm text-dark-grey/60">Calming overactive pain signals</p>
                    </div>
                </div>
                <p class="text-dark-grey/70 leading-relaxed mb-6">
                    Oral medications help desensitize hyper-irritable nerve fibers, reducing burning sensations and sharp shooting pains.
                </p>
                <ul class="space-y-3">
                    <li class="flex items-start space-x-3">
                        ...
                        <span class="text-sm text-dark-grey/80">Gabapentinoids (Pregabalin/Gabapentin)</span>
                    </li>
                    <li class="flex items-start space-x-3">
                        <div class="w-6 h-6 bg-electric-blue/10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <i class="fas fa-check text-electric-blue text-[10px]"></i>
                        </div>
                        <span class="text-sm text-dark-grey/80">SNRIs (Duloxetine) or tricyclic antidepressants</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-gradient-to-br from-cyan-accent/5 to-electric-blue/5 rounded-[24px] p-8 border border-cyan-accent/10">
                <div class="flex items-start space-x-5 mb-6">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-dark-grey mb-2">Addressing Primary Causes</h3>
                        <p class="text-sm text-dark-grey/60">Halt ongoing nerve damage</p>
                    </div>
                </div>
                <p class="text-dark-grey/70 leading-relaxed mb-6">
                    Stopping progression requires managing underlying metabolic issues, correcting deficits, or clearing toxins.
                </p>
                <ul class="space-y-3">
                    <li class="flex items-start space-x-3">
                        ...
                        <span class="text-sm text-dark-grey/80">Aggressive diabetes and HbA1c control</span>
                    </li>
                    <li class="flex items-start space-x-3">
                        <div class="w-6 h-6 bg-cyan-accent/10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <i class="fas fa-check text-cyan-accent text-[10px]"></i>
                        </div>
                        <span class="text-sm text-dark-grey/80">High-dose vitamin B12 supplementation</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-gradient-to-br from-deep-indigo/5 to-electric-blue/5 rounded-[24px] p-8 border border-deep-indigo/10">
                <div class="flex items-start space-x-5 mb-6">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-dark-grey mb-2">Balance & Gait Rehabilitation</h3>
                        <p class="text-sm text-dark-grey/60">Stability training for numb feet</p>
                    </div>
                </div>
                <p class="text-dark-grey/70 leading-relaxed mb-6">
                    Physical therapy focused on balance drills, coordination exercises, and gait retraining helps prevent falls in patients with significant numbness.
                </p>
                <ul class="space-y-3">
                    <li class="flex items-start space-x-3">
                        ...
                        <span class="text-sm text-dark-grey/80">Balance training and fall-avoidance strategies</span>
                    </li>
                    <li class="flex items-start space-x-3">
                        <div class="w-6 h-6 bg-deep-indigo/10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <i class="fas fa-check text-deep-indigo text-[10px]"></i>
                        </div>
                        <span class="text-sm text-dark-grey/80">Specialized orthotic insert fittings</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-gradient-to-br from-silver-grey/30 to-white rounded-[24px] p-8 border border-silver-grey/40">
                <div class="flex items-start space-x-5 mb-6">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-dark-grey mb-2">Immunotherapy (GBS & CIDP)</h3>
                        <p class="text-sm text-dark-grey/60">Advanced therapies for autoimmune neuropathies</p>
                    </div>
                </div>
                <p class="text-dark-grey/70 leading-relaxed mb-6">
                    For inflammatory neuropathies, we administer advanced therapies to block autoimmune antibodies and halt active myelin damage.
                </p>
                <ul class="space-y-3">
                    <li class="flex items-start space-x-3">
                        ...
                        <span class="text-sm text-dark-grey/80">Intravenous Immunoglobulin (IVIg) infusions</span>
                    </li>
                    <li class="flex items-start space-x-3">
                        <div class="w-6 h-6 bg-dark-grey/10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <i class="fas fa-check text-dark-grey text-[10px]"></i>
                        </div>
                        <span class="text-sm text-dark-grey/80">Plasmapheresis (plasma exchange)</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div class="lg:col-span-5 lg:sticky lg:top-24 self-start">
                ...
                <p class="text-dark-grey/70 leading-relaxed max-w-md">
                    Answers to common questions regarding peripheral neuropathy, nerve healing, and diabetic care.
                </p>
            </div>
                ...
                <div class="space-y-4" id="faq-container">
                    ...
                    <div class="faq-item bg-white rounded-2xl overflow-hidden border border-slate-200/80 transition-all duration-300">
                        <button class="faq-toggle w-full flex justify-between items-center p-6 text-left focus:outline-none" onclick="toggleFaq(this)">
                            <span class="font-semibold text-dark-grey pr-4 transition-colors duration-300">What is the most common cause of peripheral neuropathy?</span>
                        ...
                        <div class="faq-content hidden px-6 pb-6">
                            <p class="text-dark-grey/70 leading-relaxed">
                                Diabetes is the leading cause of chronic peripheral neuropathy. Over time, high blood glucose levels damage the walls of the tiny blood vessels (capillaries) that supply oxygen and nutrients to nerves, especially in the feet, leading to nerve dysfunction and numbness.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item bg-white rounded-2xl overflow-hidden border border-slate-200/80 transition-all duration-300">
                        <button class="faq-toggle w-full flex justify-between items-center p-6 text-left focus:outline-none" onclick="toggleFaq(this)">
                            <span class="font-semibold text-dark-grey pr-4 transition-colors duration-300">Can damaged nerves regenerate or heal?</span>
                            <span class="faq-icon-wrapper w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center flex-shrink-0 transition-all duration-300">
                                <i class="fas fa-plus text-dark-grey/50 text-xs transition-transform duration-300"></i>
                            </span>
                        </button>
                        <div class="faq-content hidden px-6 pb-6">
                            <p class="text-dark-grey/70 leading-relaxed">
                                Yes. Unlike nerves in the brain and spinal cord, peripheral nerves have the ability to slowly regenerate and heal. This is possible if the primary cause (e.g. vitamin B12 deficiency, toxins, or blood sugar spikes) is addressed and managed effectively under clinical supervision.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item bg-white rounded-2xl overflow-hidden border border-slate-200/80 transition-all duration-300">
                        <button class="faq-toggle w-full flex justify-between items-center p-6 text-left focus:outline-none" onclick="toggleFaq(this)">
                            <span class="font-semibold text-dark-grey pr-4 transition-colors duration-300">How is neuropathy diagnosed?</span>
                            <span class="faq-icon-wrapper w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center flex-shrink-0 transition-all duration-300">
                                <i class="fas fa-plus text-dark-grey/50 text-xs transition-transform duration-300"></i>
                            </span>
                        </button>
                        <div class="faq-content hidden px-6 pb-6">
                            <p class="text-dark-grey/70 leading-relaxed">
                                We diagnose neuropathy using Electrodiagnostic studies (NCV and EMG) to check nerve speed, combined with blood tests for metabolic or vitamin deficits. For small fiber neuropathies (affecting pain/temperature fibers), a simple 3mm punch skin biopsy is performed to measure epidermal nerve fiber density.
                            </p>
                        </div>
                    </div>
                </div>
...
<section class="py-12 bg-[#edf5f9]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <a href="parkinsons" class="group bg-white rounded-2xl p-6 shadow-sm border border-silver-grey/20 hover:shadow-lg hover:border-electric-blue/20 transition-all duration-300">
